...
import com.ead.authuser.configs.validations.PasswordConstraint;
import com.fasterxml.jackson.annotation.JsonView;
import jakarta.validation.constraints.Email;
import jakarta.validation.constraints.NotBlank;
import jakarta.validation.constraints.Size;

public record UserDTORequest(@NotBlank(groups = UserView.RegistrationPost.class, message = "Username is mandatory")
                             ...
                             @Size(min = 6, max = 20, groups = UserView.PasswordPut.class, message = "Old password must be between 6 and 20 characters")
